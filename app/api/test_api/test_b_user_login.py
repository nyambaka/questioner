...
class testUserLogin(unittest.TestCase):
    ...
    def test_a_with_invalid_json(self):
        ...
        self.assertEqual(json.loads(response.get_data().decode())["error"], 'this route required proper formated json ',
                         "use correct json format for this route")
        data = {}

    def test_b_with_no_data_but_correct_format(self):
        response = self.app.post(self.url_prefix + "/login", data=json.dumps(data),
